...
;hljs.registerLanguage("php-template",n)})();/*! `scss` grammar compiled for Highlight.js 11.8.0 */
(()=>{var e=(()=>{"use strict"
...
},a.FUNCTION_DISPATCH]}}})();hljs.registerLanguage("scss",e)})();/*! `vbscript-html` grammar compiled for Highlight.js 11.8.0 */
(()=>{var e=(()=>{"use strict";return e=>({name:"VBScript in HTML",
subLanguage:"xml",contains:[{begin:"<%",end:"%>",subLanguage:"vbscript"}]})})()
;hljs.registerLanguage("vbscript-html",e)})();/*! `xml` grammar compiled for Highlight.js 11.8.0 */
(()=>{var e=(()=>{"use strict";return e=>{
